...
__host__ void uploadToCM(Sphere* tabSpheres , int nbSpheres)
    ...
    size_t sizeSpheres = sizeof(Sphere)*nbSpheres; //  taille en octets de toute les spheres

    const bool IS_V1 = true; // essayer avec true et false. Difference de performance?
    if (IS_V1)
	{
