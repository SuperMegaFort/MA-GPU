...
override CXX_OPTIMISATION+= -Ofast #o3 +somme extra
override CXX_OPTIMISATION+= -ipo #optimisation, mais doit etre dans les flag de link aussi (https://www.bu.edu/tech/support/research/software-and-programming/programming/compilers/intel-compiler-flags/)


#override X86_CXX_OPTIMISATION+= -fast #pas pour sharelib
